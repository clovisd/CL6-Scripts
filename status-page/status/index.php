...
<head>
    ...
    <title>CL6 Web Company - <?php echo Misc::getHostname(); ?></title>
...
<nav role="main">
    <div id="appname">
        <a href="index.php"><span class="icon-gauge"></span>CL6</a>
        <a href="<?php echo $Config->get('esm:website'); ?>"><span class="subtitle">CL6 Server Dashboard (v<?php echo $Config->get('esm:version'); ?>)</span></a>
    </div>
